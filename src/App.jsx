...
const App = () => {
   return (
      <div className="relative overflow-hidden p-3 md:p-10 lg:py-5 min-h-screen">
         <div className="absolute blur-3xl w-[400px] h-[400px] md:w-[900px] md:h-[900px] bg-rose-500 top-0 md:-top-96 md:-left-72"></div>
         ...
         <div className="relative bg-slate-50/20 shadow-lg shadow-slate-950/50 border border-slate-300/50 rounded-lg">
